...
config :app, AppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "uus1blq1xF80BdKCc/3GbiSk/rlVxwFAAYR05CKYRsWzZ+wndGN+jjlzhQ/DAcBk",
  watchers: [
...
# ClickHouse logger backend (always enabled in dev)
config :logger,
  backends: [:console, ClickhouseLogger]

config :logger, ClickhouseLogger,
  base_uri: "http://localhost:8124",
  database: "logs",
  fields: [
    ts: :timestamp,
